...
It should be pretty close to the true probability because there are only 3 options are the sample size is very large (red=0.5, white=0.125, blue=0.375)
...
I predict it to be the sum of the following (0.5*0.5)+(0.125*0.125)+(0.375*0.375)
